...
class DaoServer:
    ...
    def isLock(self, i_id):
        with open("C:/Users/caves/Desktop/毕业设计/userfile.txt", 'r') as seaFile:
    ...
    def register(self, user):
        if self.searchBlock(user.Count_IDCard):
            ...
            with open("C:/Users/caves/Desktop/毕业设计/userfile.txt", 'a+') as writeFile:
    ...
    def proof(self, pId, pPassword):
        with open("C:/Users/caves/Desktop/毕业设计/userfile.txt", 'r') as proofFile:
    ...
    def Lock(self, lockU, res):
        lId = lockU.Count_id
        r_mes = []
        with open('C:/Users/caves/Desktop/毕业设计/userfile.txt', 'r') as rFile:
        ...
        with open('C:/Users/caves/Desktop/毕业设计/userfile.txt', 'w') as file:
            pass
